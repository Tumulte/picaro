...
div(id="_color" class="_panel" v-if="displayPanel")
    v-card(class="_container pa-3 ma-3" id="_range-light-container")
        v-slider(label="Count" show-ticks="always" tick-size="3" min="3" max="10" v-model="styleSet.colorGeneratorParams.count" @change="generateColors()" )
        h3 hue
        v-slider(label="variation" show-ticks="always" tick-size="3" min="0" max="10"  v-model="styleSet.colorGeneratorParams.hue.variation" @change="generateColors()" )
        v-slider(label="curve" show-ticks="always" tick-size="3" min="0" max="10"  v-model="styleSet.colorGeneratorParams.hue.curve" @change="generateColors()" )
        v-slider(label="move" show-ticks="always" tick-size="3" min="-8" max="8"  v-model="styleSet.colorGeneratorParams.hue.move" @change="generateColors()" )
        h3 Light
        v-slider(label="variation" show-ticks="always" tick-size="3" min="0" max="10"  v-model="styleSet.colorGeneratorParams.light.variation" @change="generateColors()" )
        v-slider(label="curve" show-ticks="always" tick-size="3" min="0" max="10"  v-model="styleSet.colorGeneratorParams.light.curve" @change="generateColors()" )
        v-slider(label="move" show-ticks="always" tick-size="3" min="-8" max="8"  v-model="styleSet.colorGeneratorParams.light.move" @change="generateColors()" )
        h3 Saturation
        v-slider(label="variation" show-ticks="always" tick-size="3" min="0" max="10"  v-model="styleSet.colorGeneratorParams.saturation.variation" @change="generateColors()" )
        v-slider(label="curve" show-ticks="always" tick-size="3" min="0" max="10"  v-model="styleSet.colorGeneratorParams.saturation.curve" @change="generateColors()" )
        v-slider(label="move" show-ticks="always" tick-size="3" min="-8" max="8"  v-model="styleSet.colorGeneratorParams.saturation.move" @change="generateColors()" )
        h3 text
        v-slider(label="variation" show-ticks="always" tick-size="3" min="0" max="10"  v-model="styleSet.colorGeneratorParams.text.variation" @change="generateColors()" )
        v-slider(label="curve" show-ticks="always" tick-size="3" min="0" max="10"  v-model="styleSet.colorGeneratorParams.text.curve" @change="generateColors()" )
        v-slider(label="move" show-ticks="always" tick-size="3" min="-8" max="8"  v-model="styleSet.colorGeneratorParams.text.move" @change="generateColors()" )
...
export default {
  ...
  methods: {
    ...
    resetSetting(setting, index) {
      const newSettings = this.styleSet.colorParameterCollection[index]
