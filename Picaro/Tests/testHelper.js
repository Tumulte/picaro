export default function vueTestingHelper(wrapper) {
    ...
    this.get = function (attributeName, extraAttributes = "", newRoot, ...args) {
        return this.fetchElement("get", args);
    };
    this.find = function (attributeName, extraAttributes = "", newRoot, ...args) {
        return this.fetchElement("find", args);
    };
    this.tick = function () {
