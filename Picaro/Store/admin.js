...
export default {
  ...
  mutations: {
    ...
    currentColor(state, coordinates) {
      if (state.currentSelector) {
          state.styleSet.selectorCollection[state.currentSelector.selector][state.currentSelector.property] =
          {
            type: "color",
            data: coordinates
          }
  ...
  actions: {
    updateProperty({ state, dispatch }, value) {
      state.styleSet.selectorCollection[value.selector][value.new] = state.styleSet.selectorCollection[value.selector][value.old];
      delete state.styleSet.selectorCollection[value.selector][value.old];
      dispatch("triggerNewStyle");
    },
    updateSelector({ state, dispatch }, value) {
      state.styleSet.selectorCollection[value.new] = state.styleSet.selectorCollection[value.old]
      delete state.styleSet.selectorCollection[value.old];

      dispatch("triggerNewStyle");
    },
    addSelector({ state, dispatch }, value) {
      state.styleSet.selectorCollection[value] = {};
      dispatch("triggerNewStyle");
    },
    addProperty({ state, dispatch }, data) {
      state.styleSet.selectorCollection[data.selector][data.property] = data.value ? data.value : ""
      dispatch("triggerNewStyle");
    },
    updateStyles({ state, dispatch }, data) {
      ...
      state.styleSet.selectorCollection[data.selector][data.property] = data.value
